...
namespace fStar {
    ...
    struct FStarNodeEdges {
        ...
        FStarNodeEdges() {
            this->_edges = new vector<FStarEdgeEntry>();
    ...
    namespace FStarIterator {
        ...
        public:
            EdgeIterator(
                map<int, FStarNodeEdges *>::iterator m_it,
                map<int, FStarNodeEdges *>::iterator m_end) : map_it(m_it), map_end(m_end) {
                if (map_it != map_end) {
                    vec_it = map_it->second->_edges->begin();
                    advance_to_valid();
                }
    ...
    public:
        ...
        size_t sizeNodes() const { return this->Edges->size(); }
